...
{
    internal const string IncludedIndicator = "Chat 3: ";

    internal static readonly Font[] GlobalFonts = {
        new(
            $"{IncludedIndicator}Noto Sans",
            "ChatThree.fonts.NotoSans-Regular.ttf",
            "ChatThree.fonts.NotoSans-Italic.ttf"
        ),
        new(
            $"{IncludedIndicator}Noto Serif",
            "ChatThree.fonts.NotoSerif-Regular.ttf",
            "ChatThree.fonts.NotoSerif-Italic.ttf"
        ),
        new(
            $"{IncludedIndicator}Open Sans",
            "ChatThree.fonts.OpenSans-Regular.ttf",
            "ChatThree.fonts.OpenSans-Italic.ttf"
        ),
        new(
            $"{IncludedIndicator}Roboto",
            "ChatThree.fonts.Roboto-Regular.ttf",
            "ChatThree.fonts.Roboto-Italic.ttf"
        ),
    };

    internal static readonly (string, string)[] JapaneseFonts = {
        ($"{IncludedIndicator}Noto Sans JP", "ChatThree.fonts.NotoSansJP-Regular.otf"),
        // ($"{IncludedIndicator}Noto Serif JP", "ChatThree.fonts.NotoSerifJP-Regular.otf"),
    };
